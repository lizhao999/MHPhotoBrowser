...
@interface MHPhotoBrowserView() <UIScrollViewDelegate>
...
@property (nonatomic, assign) BOOL hasLoadedImage;  //是否加载完图片
@end

@implementation MHPhotoBrowserView
...
- (void)setImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder
{
    ...
    //添加进度指示器
    MHProgressView *progressView = [[MHProgressView alloc] init];
    progressView.mode = MHWaitingViewModeLoopDiagram;
    progressView.center = CGPointMake(kAPPWidth * 0.5, KAppHeight * 0.5);
